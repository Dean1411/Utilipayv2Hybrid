...
public class EndToEnd extends Base {
    ...
    private void createMunicipalityIfNotExists(String municipalityName) throws InterruptedException {
        if (!DatabaseUtilsEnd2End.municipalityExists(municipalityName)) {
            nav.click_Admin();
...
//    @Test(priority = 1, dependsOnMethods = "loginOnce", retryAnalyzer = Retry.class)
...
//    }
//    
//    @Test(priority = 2, dependsOnMethods = "createMunicipality", retryAnalyzer = Retry.class)
...
//    }
//    
//    @Test(priority = 3, dependsOnMethods = "searchForUser", retryAnalyzer = Retry.class)
//    public void selectMunicipality() throws InterruptedException {
//         
//    	try {
//    		usrMng.selectMun(prop.getProperty("clientName"));
//        	System.out.println("New Muncipality successfuly linked to user profile");
//    	}catch(Exception ex) {
//    		
...
//
//
//    @Test(priority = 4, dependsOnMethods = "selectMunicipality", retryAnalyzer = Retry.class)
...
//        String importMsg =importFile.getMsg();
//        
//        if(!importMsg.isEmpty() && importMsg.contains("File uploaded successfully")){
//        	
//        	fileImported = true;
...
//        }
//        
//    	System.out.println("3. File imported");
//    }
//
//    @Test(priority = 5, dependsOnMethods = "performImport", retryAnalyzer = Retry.class)
//    public void createNewTariff() throws InterruptedException {
//    	String browser = "edge";
//    	
//    	try {
//    		
...
//                nav.click_Admin();
//                nav.click_MunicipalManagement();
//                mun.searchMunicipality("Dean Municipality");
//                mun.municipalActions("Manage Sgc");
//                nav.navigateTo("Municipal Maintenance");
//                mun.searchMunicipality("Dean Municipality");
//                mun.municipalActions("Manage Tariff");
//                mun.searchTariff("W /W500");
//                mun.tableBody();
//                mun.addYear();
//                mun.selectYrStart("2025");
//                mun.selectYrEnd("2026");
...
//                mun.saveAllStepsBtn();
//                
//            	System.out.println("4. New sgc, tariff code and steps successfuly created");
//    		}  		
//    	}catch (Exception ex){
//    		
//    		System.out.println("Exception: " + ex.getMessage());
...
//    }
//    
//    @Test(priority = 6, dependsOnMethods = "createNewTariff", retryAnalyzer = Retry.class)
//    public void purchaseUnitsAndValidate() throws InterruptedException {
//    	
//    	try {
//    		
//    		if(fileImported) {
...
//            	nav.click_Transact();
//
//            	String meterNumber = prop.getProperty("end2endMtr");
//
//            	tranPg.insert_MtrNum(meterNumber);
//            	Thread.sleep(1000); 
//
...
//            	if (meterId != null) {
//            		
//            	    String lastStep = DatabaseUtilsEnd2End.getLastStep(meterId);
//            	    double units = DatabaseUtilsEnd2End.getLastUnits(meterId);
//
//            	    System.out.println("Meter ID: " + meterId);
//            	    System.out.println("Last Step: " + lastStep);
//            	    System.out.println("Units: " + units);
//            	} else {
//            	    System.err.println("Meter ID not found!");
//            	}
//    		}else {
//    			
//    			Assert.assertTrue(fileImported, "Cannot perform purchase — file import failed.");
//    		}
//    	}catch(Exception ex) {
//    		
